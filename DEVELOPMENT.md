...
```bash
git remote add encore encore://car-showroom-backend-sya2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/car-showroom-backend-sya2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/car-showroom-backend-sya2/settings/integrations/github)
